...
import (
	...
	"gitlab.com/frontier3302117/golang/gin-i18n/testdata"
)
...
func TestTranslate(t *testing.T) {
	...
	for _, tt := range tests {
		...
		runTranslationTest(t, tt, name, nil)

		name = "FileLoader-" + tt.args.lng.String() + "-" + tt.args.msgID + "-" + tt.name
		runTranslationTest(t, tt, name, []Loader{
...
func runTranslationTest(t *testing.T, tt testTranslation, name string, ls []Loader) {
	t.Run(name, func(t *testing.T) {
		...
		i := New(
			WithLanguages([]language.Tag{tt.args.lng}),
